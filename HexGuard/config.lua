...
≺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━≻--]]
-- DOCS: https://peleg.gitbook.io/hexguard/
...
hexguard.ServerName = "The Revolution City RP"                                                                   -- The name of the server.
hexguard.DiscordLink = "https://discord.gg/vP9ZykvvJk"                                                                  -- The link to your discord server.
hexguard.RequireSteam = false                                                              -- Just requires players that want to join your server to have steam open and logged in as well u must have a valid steam api key for this option read more in docs
hexguard.IdentifierCheck = true                                                            -- Checks when player connects if his identifiers are valid. if not it won't let him join the server.
hexguard.Debug = true 																      -- Enables debug mode, this will print debug messages in the console.
...
-- This system is Fivem Built-in and not created by hexguard's team...
hexguard.ServerSecurity = {
...
-- 2) Enable the option below ( set hexguard.AutoConfig to true and not false as follows 'hexguard.AutoConfig = true' )
...
-- hexguard Logs they are
hexguard.Logs = {
    -- Discord logger settings
    Enabled = true,         -- Enable or disable all Discord logging features
    
    -- Core webhook endpoints
    system = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",            -- System logs (startup, shutdown, etc.)
    detection = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",         -- Detection logs (player cheating detections)
    ban = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",               -- Ban logs
    kick = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",              -- Kick logs
    screenshot = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",        -- Screenshot logs
    admin = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",             -- Admin action logs
    debug = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",             -- Debug logs for troubleshooting
    
    -- New webhook endpoints
    join = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",              -- Player join logs
    leave = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",             -- Player leave logs
    kill = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr",              -- Player kill logs
    resource = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"           -- Resource start/stop logs
}

hexguard.Permissions = {
	...
	DefaultAce = "hex.admin",
	
	-- Group-specific ACE permissions
	GroupAces = {
		["admin"] = "hex.admin",
		["moderator"] = "hex.moderator",
		["staff"] = "hex.staff"
	},
	...
	BypassPermissions = {
		["teleport"] = "hex.bypass.teleport",         -- Bypass teleport detection
		["visions"] = "hex.bypass.visions",           -- Bypass night/thermal vision detection
		["speedhack"] = "hex.bypass.speedhack",       -- Bypass speed hack detection
		["spectate"] = "hex.bypass.spectate",         -- Bypass spectate detection
		["noclip"] = "hex.bypass.noclip",             -- Bypass noclip detection
		["ocr"] = "hex.bypass.ocr",                   -- Bypass OCR detection
		["playerblips"] = "hex.bypass.playerblips",   -- Bypass player blips detection
		["invisible"] = "hex.bypass.invisible",       -- Bypass invisible player detection
		["godmode"] = "hex.bypass.godmode",           -- Bypass god mode detection
		["freecam"] = "hex.bypass.freecam",           -- Bypass freecam detection
		["superjump"] = "hex.bypass.superjump",       -- Bypass super jump detection
		["noragdoll"] = "hex.bypass.noragdoll",       -- Bypass no ragdoll detection
		["infinitestamina"] = "hex.bypass.infinitestamina", -- Bypass infinite stamina detection
		["magicbullet"] = "hex.bypass.magicbullet",   -- Bypass magic bullet detection
		["norecoil"] = "hex.bypass.norecoil",         -- Bypass no recoil detection
		["aimassist"] = "hex.bypass.aimassist",       -- Bypass aim assist detection
		
		-- Master bypass permission (overrides all others)
		["all"] = "hex.bypass.all"                    -- Bypass all client-side detections
	}
}
...
hexguard.BanTimes = { -- Preset ban times, preset name can be used in the protections.
	["Ban"] = 2147483647, -- Perm
	["Kick"] = -1,        -- Kick
	["Warn"] = 0,         -- Warn
}
...
hexguard.Webhooks.Simple = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"
hexguard.Protection.Simple = {     
...
hexguard.OCR = { -- Words on scrren that will get player banned
...
hexguard.Weapons = { -- Add all your weapons to here most of the weapons should arlready be here make sure u added all of them if you are using qbcore if not u can delete this
...
hexguard.Webhooks.BlacklistedExplosions = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"  -- Takes action if an explosion with the id got detected.
hexguard.Protection.BlacklistedExplosions = {
...
hexguard.Webhooks.BlacklistedCommands = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"
hexguard.Protection.BlacklistedCommands = { -- Takes action if a blacklisted command is registered.
...
hexguard.Webhooks.BlacklistedSprites = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"
hexguard.Protection.BlacklistedSprites = { -- Takes action if a blacklisted sprite is detected.
...
hexguard.Webhooks.BlacklistedAnimDicts = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"
hexguard.Protection.BlacklistedAnimDicts = { -- Takes action if a blacklisted anim dict got loaded.
	{ dict = "rcmjosh2",       time = "Ban", webhook = "" },
	{ dict = "rcmpaparazzo_2", time = "Ban", webhook = "" },
}

hexguard.Webhooks.BlacklistedWeapons = ""
hexguard.Protection.BlacklistedWeapons = { -- Weapons Names can be found here: https://gtahash.ru/weapons/
...
hexguard.Webhooks.BlacklistedVehicles = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"
hexguard.Protection.BlacklistedVehicles = { -- Vehicles List can be found here: https://wiki.rage.mp/index.php?title=Vehicles
...
hexguard.Protection.BlacklistedPeds = { -- Add blacklisted ped models here
...
hexguard.Webhooks.BlacklistedObjects = "https://discord.com/api/webhooks/1369007356523843665/4lMOmQ2V3nDfj58qrlyiTa2OQaf_428t4gXCHwmUHgAjorfzSERxUI9ytDzcPDYONogr"
hexguard.Protection.BlacklistedObjects = {
