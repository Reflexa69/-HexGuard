...
function ClientInit.initialize()
    ...
    logger.info("==============================================")
    logger.info("hexguard Client v1.2.1 initializing...")
    
    ConfigLoader.initialize()
    logger.info("Config Loader initialized")
    
    local hexguard = ConfigLoader.hexguard()
    ...
    Citizen.CreateThread(function()
        Wait(2000) 
        TriggerServerEvent("hexguard:CheckWhitelist")
    end)
    ...
    RegisterNetEvent("hexguard:UpdateDebugMode", function(enabled)
        local logger = require("client/core/client_logger")
